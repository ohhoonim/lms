...
import dev.ohhoonim.user.application.ActivateActivity;
import dev.ohhoonim.user.application.DormantActivity;
import dev.ohhoonim.user.application.LockActivity;
import dev.ohhoonim.user.application.LoginActivity;
import dev.ohhoonim.user.application.ModifyInfo;
import dev.ohhoonim.user.application.RegisterActivity;
import dev.ohhoonim.user.application.ResetPasswordActivity;
...
import dev.ohhoonim.user.application.ViewInfoActivity;
import dev.ohhoonim.user.application.WithdrawActivity;
import dev.ohhoonim.user.port.UserPort;
import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public final class UserService extends User
        implements ActivateActivity, DormantActivity, LockActivity, LoginActivity, ModifyInfo,
        RegisterActivity, ResetPasswordActivity, ViewInfoActivity, WithdrawActivity {
    ...
    public boolean verifyPassword(User username, String inputPassword) {
        checkUsername(username);
        return !userPort
                .verifyLoginUser(username.getUsername(), passwordEncoder.encode(inputPassword))
                .isEmpty();
    }
